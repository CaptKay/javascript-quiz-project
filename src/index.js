document.addEventListener("DOMContentLoaded", () => {
  ...
  const restartQuizElement = document.querySelector("#restartButton");
...
const timeRemainingContainer = document.getElementById("timeRemaining");
  ...
  function showQuestion() {
    ...
    progressBar.style.width = `${questionPercentage}%`; // This value is hardcoded as a placeholder
    ...
    const quizChoices = question.choices;
    ...
    quizChoices.forEach((choice) => {
      ...
      radioElement.id = "choice";
      radioElement.name = "choice";
      radioElement.value = choice;
      labelElement.innerText = choice;

      newLiElement.append(radioElement, labelElement);
  ...
  function showResults() {
    ...
    // Restart the quiz
    restartQuizElement.addEventListener("click", () => {
